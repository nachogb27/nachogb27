...
- ⚛️ Building **Single Page Applications** with React and Node.js
- 🗄️ Developing **REST APIs** and learning **GraphQL**
...
- 📱 **REST API Development** with Express and MongoDB
- 🗄️ **Database Design** and management
- 🔧 **Algorithm Implementation** in multiple languages
